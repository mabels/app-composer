import { EntryPoint, Invocation, InvokableArgs } from '@app-composer/types';
import { loadConfig } from '../functions/config-loader';

export class InvocationApi implements Invocation {
  ...
  public static fill(obj: any): Invocation {
    return new InvocationApi(obj.packageName, obj.jsEntryPoints,
